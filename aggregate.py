'''Aggregate Trained models on CIFAR100 with PyTorch.'''
...
parser = argparse.ArgumentParser(description='PyTorch CIFAR100 aggregation')
...
def extractoutputs(loader,namesave='./checkpoint/ckpt',batch_size=1,nsplit=10,nclasses=100,nbobs=10000):
